-- MIGRATION: 20260117_update_transport_rpc_security.sql
-- PURPOSE: Allow TRANSPORT_SCHEDULER to view schedules for their station
...
BEGIN
  ...
  WHERE 
    ...
    (
        ...
        OR
        -- Station Admin/Supervisor/Scheduler: See Own Station
        (s.station_id = v_user_station AND v_user_role IN ('ADMIN', 'SUPERVISOR', 'TRANSPORT_SCHEDULER'))
        OR
